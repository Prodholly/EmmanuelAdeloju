...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/EmmanuelAdeloju/";
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/EmmanuelAdeloju/people/";
          },
        ...
        section: 'Socials',
        handler: () => {
          window.open("/EmmanuelAdeloju/assets/pdf/example_pdf.pdf", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        ...
        section: 'Socials',
        handler: () => {
          window.open("/EmmanuelAdeloju/feed.xml", "_blank");
        },
      },{
        id: 'social-scholar',
